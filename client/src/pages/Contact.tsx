      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-900 py-16">
          <div className="container">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              Have questions, feedback, or need assistance? We're here to help you with anything related to Fan Lite Fantasy Cricket.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 container">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <Card className="bg-card border-border text-center">
              ...
              <CardContent>
                <a 
                  href="https://www.FanLiteFantasyCricket.com" 
                  target="_blank" 
            ...
            <div className="space-y-6">
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    For general questions about Fan Lite Fantasy Cricket, how to play, or platform features, please visit our FAQ page first. If you can't find your answer there, reach out to us through our website.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    We're always looking to improve! If you have ideas for new features, improvements, or any feedback about your experience, we'd love to hear from you. Your input shapes the future of Fan Lite Fantasy Cricket.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container text-center max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground">
              We strive to respond to all inquiries within 24-48 hours. Your satisfaction and gaming experience are our top priorities. Thank you for being part of the Fan Lite Fantasy Cricket community!
            </p>
          </div>
        </section>
      </main>
